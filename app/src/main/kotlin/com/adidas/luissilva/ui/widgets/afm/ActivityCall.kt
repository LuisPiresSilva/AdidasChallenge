package com.adidas.luissilva.ui.widgets.afm
...
class ActivityCall private constructor() : Builder() {
    ...
    override fun build() {
        ...
        if (!shareElementsMap.isEmpty()) {
            ...
            bundleOptions = ActivityOptionsCompat.makeSceneTransitionAnimation(activity
                    ?: fragment?.requireActivity() as BaseActivity<*,*>, *shareElementsMap).toBundle()
        }
    ...
    fun getIntent(): Intent {
        ...
        if (shareElementsMap.isNotEmpty()) {
            intent.putExtra(BaseActivity.ACTIVITY_MANAGER_FRAGMENT_SHARED_ELEMENTS, true)
            bundleOptions =
                    ActivityOptionsCompat.makeSceneTransitionAnimation(activity ?: fragment?.requireActivity() as BaseActivity<*,*>, *shareElementsMap).toBundle()
        }
