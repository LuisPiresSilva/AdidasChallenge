...
import com.adidas.luissilva.ui.animation.AnimationType
import com.adidas.luissilva.ui.animation.TransactionAnimation
import com.adidas.luissilva.ui.dialog.ErrorDialog
import com.adidas.luissilva.ui.dialog.LoadingDialog
import com.adidas.luissilva.ui.widgets.afm.OnBackPressedListener
import com.adidas.luissilva.utils.helper.DebounceTimer
import com.adidas.luissilva.utils.helper.extensions.hideKeyboard
import com.adidas.luissilva.utils.helper.extensions.setSystemBarTransparent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (supportFragmentManager.fragments.isEmpty() && supportFragmentManager.backStackEntryCount == 0) {
            if (intent.hasExtra(ACTIVITY_MANAGER_FRAGMENT)) {
                performInitialTransaction(intent.getStringExtra(ACTIVITY_MANAGER_FRAGMENT)?.let { getFragment(it) }, getFragmentTag())
